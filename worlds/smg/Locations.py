...
from worlds.smg.Types import LocData
...
def did_include_extra_locations(world: "SMGWorld") -> bool:
...
def get_total_locations(world: "SMGWorld") -> int:
...
def is_valid_location(world: "SMGWorld", name) -> bool:
    if not did_include_extra_locations(world) and name in extra_locations:
        return False
