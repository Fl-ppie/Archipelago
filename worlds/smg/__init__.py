...
from worlds.smg.Locations import get_location_names, get_total_locations
from worlds.smg.Items import create_item, create_itempool, item_table
from worlds.smg.Options import SMGOptions
from worlds.smg.Regions import create_regions
from worlds.smg.Types import ChapterType, chapter_type_to_name
...
class SMGWorld(World):
    """
    A randomiser for Super Mario Galaxy.
